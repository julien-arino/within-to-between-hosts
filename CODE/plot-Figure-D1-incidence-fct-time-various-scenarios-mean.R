...
cat("\n\n>>> Running plot-Figure-D1-incidence-fct-time-various-scenarios-mean.R ...\n\n")
...
cat("\n\n>>> plot-Figure-D1-incidence-fct-time-various-scenarios-mean.R successfully finished running ✅\n\n")
