#!/usr/bin/env Rscript
# ============================================================
# File: plot-Figure-E2-R0P-vs-Vmax.R
# Description:
...
# Save figure
# ---------------------------
out_png <- file.path(figs_dir, "Figure-E2-R0P-vs-Vmax.png")
out_pdf <- file.path(figs_dir, "Figure-E2-R0P-vs-Vmax.pdf")
...
print_end_time(start_time, "plot-Figure-E2-R0P-vs-Vmax.R")
