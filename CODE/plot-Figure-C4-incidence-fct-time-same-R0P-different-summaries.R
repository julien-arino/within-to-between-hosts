# ============================================================
# File: plot-Figure-C4-incidence-fct-time-same-R0P-different-summaries.R
...
out_pdf <- "FIGS/plot_Figure_C4_incidence_fct_time_same_R0P_different_summaries.pdf"
out_png <- "FIGS/plot_Figure_C4_incidence_fct_time_same_R0P_different_summaries.png"
