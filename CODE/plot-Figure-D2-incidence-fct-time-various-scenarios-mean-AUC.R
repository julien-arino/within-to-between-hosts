...
out_pdf <- file.path(fig_dir, "Figure-D2-incidence-fct-time-various-scenarios-mean-AUC.pdf")
out_png <- file.path(fig_dir, "Figure-D2-incidence-fct-time-various-scenarios-mean-AUC.png")
ggsave(out_pdf, p, width=22, height=12, units="cm")
ggsave(out_png, p, width=22, height=12, units="cm")
cat("✅ Plot saved to", out_pdf, "\n")

cat("\n\n>>> plot-Figure-D2-incidence-fct-time-various-scenarios-mean-AUC.R successfully finished running ✅\n\n")
