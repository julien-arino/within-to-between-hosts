...
ggsave("FIGS/Figure-D2-incidence-fct-time-various-scenarios-mean-AUC.pdf",
       p, width=22, height=12, units="cm")
ggsave("FIGS/Figure-D2-incidence-fct-time-various-scenarios-mean-AUC.png",
       p, width=22, height=12, units="cm")
cat("✅ Plot saved to FIGS/Figure-D2-incidence-fct-time-various-scenarios-mean-AUC.pdfn")
