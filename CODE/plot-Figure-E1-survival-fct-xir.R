...
# ============================================================
# File: plot-Figure-E1-survival-fct-xir.R
...
start_time <- start_time_and_hello("plot-Figure-E1-survival-fct-xir.R")
...
p <- ggplot(
  ...
  scale_color_manual(
    values = c("1" = "mistyrose3", "4" = "firebrick3"),
...
# Save results
out_pdf <- file.path(figs_dir, "Figure-E1-survival-fct-xir.pdf")
out_png <- file.path(figs_dir, "Figure-E1-survival-fct-xir.png")
...
print_end_time(start_time, "plot-Figure-E1-survival-fct-xir.R")
