# ============================================================
# File: plot-Figure-C2-incidence-fct-time-various-scenarios-mean-AUC.R
...
ggsave("FIGS/plot_Figure_C2_incidence_fct_time_various_scenarios_mean_AUC.pdf",
       p, width=22, height=12, units="cm")
ggsave("FIGS/plot_Figure_C2_incidence_fct_time_various_scenarios_mean_AUC.png",
       p, width=22, height=12, units="cm")
cat("✅ Plot saved to FIGS/plot_Figure_C2_incidence_fct_time_various_scenarios_mean_AUC.pdf\n")
