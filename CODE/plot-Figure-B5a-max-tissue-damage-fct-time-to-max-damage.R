# ============================================================
# File: plot-Figure-B5a-max-tissue-damage-fct-time-to-max-damage.R
...
out_pdf <- "FIGS/plot_Figure_B5a_max_tissue_damage_fct_time_to_max_damage.pdf"
out_png <- "FIGS/plot_Figure_B5a_max_tissue_damage_fct_time_to_max_damage.png"
