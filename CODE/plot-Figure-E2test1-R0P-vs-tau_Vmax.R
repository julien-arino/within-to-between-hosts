#!/usr/bin/env Rscript
# ============================================================
# File: plot-Figure-E2test1-R0P-vs-tau_Vmax.R
# Description:
#   Plots the normalized difference between R0_P2P and R0_within 
#   against time to peak viral load (tau_V_max)
# ============================================================

project_dir <- here::here()
source(file.path(project_dir, "CODE", "functions-and-definitions.R"))

start_time <- start_time_and_hello("plot-Figure-E2test1-R0P-vs-tau_Vmax.R")
...
p2 <- ggplot(summary_df, aes(x = x_var, y = R0_diff)) +
  ...
  labs(
    x = expression("Time to peak viral load" ~ tau[i]^{V[max]} ~ "(days)"),
...
# Save figure
# ---------------------------
out_png <- file.path(figs_dir, "Figure-E2test1-R0P-vs-tau_Vmax.png")
out_pdf <- file.path(figs_dir, "Figure-E2test1-R0P-vs-tau_Vmax.pdf")
...
print_end_time(start_time, "plot-Figure-E2test1-R0P-vs-tau_Vmax.R")
