#!/usr/bin/env Rscript
# ============================================================
# File: debug-Figure-08a-pdf-fr-fct-xir.R
# Description: Plot f_r for raw, spline, and rolling average
# ============================================================

project_dir <- here::here()
source(file.path(project_dir, "CODE", "functions-and-definitions.R"))

start_time <- start_time_and_hello("debug-Figure-08a-pdf-fr-fct-xir.R")
...
p <- ggplot(
  ...
  labs(
    ...
    y = expression("Probability density function" ~ f[r]),
    color = "Filter Type",
    fill = "Filter Type"
  ) +
...
out_pdf <- file.path(figs_dir, "debug-Figure-08a-pdf-fr-fct-xir.pdf")
out_png <- file.path(figs_dir, "debug-Figure-08a-pdf-fr-fct-xir.png")
...
print_end_time(start_time, "debug-Figure-08a-pdf-fr-fct-xir.R")
