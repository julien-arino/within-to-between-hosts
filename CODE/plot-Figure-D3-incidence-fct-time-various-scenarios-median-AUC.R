...
ggsave("FIGS/Figure-D3-incidence-fct-time-various-scenarios-median-AUC.pdf",
       p, width=22, height=12, units="cm")
ggsave("FIGS/Figure-D3-incidence-fct-time-various-scenarios-median-AUC.png",
       p, width=22, height=12, units="cm")
cat("✅ Plot saved to FIGS/Figure-D3-incidence-fct-time-various-scenarios-median-AUC.pdfn")
