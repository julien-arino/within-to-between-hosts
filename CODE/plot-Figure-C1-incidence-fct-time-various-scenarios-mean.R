# ============================================================
# File: plot-Figure-C1-incidence-fct-time-various-scenarios-mean.R
...
ggsave("FIGS/plot_Figure_C1_incidence_fct_time_various_scenarios_mean.pdf",
       p, width=22, height=12, units="cm")
ggsave("FIGS/plot_Figure_C1_incidence_fct_time_various_scenarios_mean.png",
       p, width=22, height=12, units="cm")
cat("✅ Plot saved to FIGS/plot_Figure_C1_incidence_fct_time_various_scenarios_mean.pdf\n")
